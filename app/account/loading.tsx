    ...
    <div className="fixed inset-0 z-[110] grid place-items-center bg-background/88 backdrop-blur-sm">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <p className="font-heading text-xl font-semibold text-foreground">Loading your account</p>
          <p className="mt-2 text-sm text-muted-foreground">Preparing saved profile, support, and recent order details.</p>
        </div>
      </div>
    </div>
  )
